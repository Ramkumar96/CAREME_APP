...
/**
 * @desc Creating the Nurse List Component of Nurse for Unregistered client view
 * 
 */
        ...
        {/* <div className="p-3 "> */}
          ...
          <div id={`${this.props.nType}`} className={`${this.props.nType}`}>
                <div className="card " style={{ width: '18rem' } }>
                  <img className="card-img-top" src={this.props.pic} alt="Card image cap"  style={{ height: '15rem' } } />
