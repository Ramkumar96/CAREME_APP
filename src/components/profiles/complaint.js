...
//validating empty complaint model
...
class Complaint extends Component {
  ...
  render() {
	//validating the fields in the complaint model to check whether it is empty
	const errors = validateComplaint(this.state.feedback);
