        ...
        return(
            <div>  
                ...
                {/* first row cover photo */}
                   <div className="row">
                       <div className="col-lg-12  image-section">
                   ...
                   <div className="row">
                       {/* profile photo coloumn */}
                        <div className="col-lg col-md-3 col-sm-12 text-center profile-blue">
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 profile-blue middle-container ">
                                    <div className="row">
                                        <div className="col-md-8 col-sm-6 col-xs-6">
                                            <h3>Saroj Seram</h3>
                                            <h5>Patients profle</h5>
                                        </div> 
                                    </div>
                                    <br/>

                                {/* <div className="row proinfo"> */}
                   ...
                   <div className="row">
                       <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 image-section reviewbanner">
